...
export default function Profile() {
  return (
    <section id="profile">
      <div className="container mx-auto py-32 px-10 2xl:px-10">
        <Judul judul="Profile" desc="Mengenal saya secara singkat." />
        <div className="flex mx-auto mt-10 flex-wrap xl:w-9/12 lg:items-center md:items-start">
